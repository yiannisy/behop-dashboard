...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'logs_client', 'type', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Client.os'
        db.alter_column(u'logs_client', 'os', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Client.user'
        db.alter_column(u'logs_client', 'user', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # Changing field 'Client.type'
        db.alter_column(u'logs_client', 'type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Client.os'
        db.alter_column(u'logs_client', 'os', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Client.user'
        db.alter_column(u'logs_client', 'user', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
