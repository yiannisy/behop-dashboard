...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NetflixLog.session_id'
        db.add_column(u'logs_netflixlog', 'session_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NetflixLog.session_id'
        db.delete_column(u'logs_netflixlog', 'session_id')
    ...
    models = {
        ...
        u'logs.netflixlog': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'logs.rttlog': {
