...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.last_seen'
        db.add_column(u'logs_client', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.last_seen'
        db.delete_column(u'logs_client', 'last_seen')
